...
class goblinLPSolver : public virtual goblinILPWrapper
{
private:
...
public:
    ...
    objectType      ClassID() const throw() {return IDNativeLpObject;};
    ...
    inline TRestr  K() const throw();

    inline TVar  L() const throw();

    inline TIndex  NZ() const throw();
...
inline TRestr goblinLPSolver::K() const throw()
{
    return kAct;
}


inline TVar goblinLPSolver::L() const throw()
{
    return lAct;
}


inline TIndex goblinLPSolver::NZ() const throw()
{
    return coeff->NZ();
}
...
class nativeLPModule : public virtual goblinILPModule
{
public:

    nativeLPModule() throw() : managedObject(goblinDefaultContext) {};
    ...
    goblinILPWrapper*
        ...
        {return (goblinLPSolver*)X;};

    ~nativeLPModule() throw() {};

    objectType ClassID() const throw()   {return IDNativeLpModule;};
    void*   BackCast() const throw()     {return (void*)this;};
    void    DeleteYourself() throw()     {delete this;};

    char*   Authors() const throw()
        {return "Bernhard Schmidt, Christian Fremuth Paeger";};
    int     MajorRelease() const throw() {return 1;};
    int     MinorRelease() const throw() {return 0;};
    char*   PatchLevel() const throw()   {return "";};
    char*   BuildDate() const throw()    {return "2003/05/01";};
    char*   License() const throw()      {return "LGPL";};

    TLPOrientation  Orientation() const throw() {return COLUMN_ORIENTED;};
};
