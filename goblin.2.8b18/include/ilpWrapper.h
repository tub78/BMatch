...
/// \file   ilpWrapper.h
/// \brief  #goblinILPWrapper class interface
...
class goblinILPWrapper : public managedObject
{
private:
...
public:
    ...
    goblinILPWrapper(goblinController&) throw();
    virtual ~goblinILPWrapper() throw();

    unsigned long   Allocated() const throw();

    bool            IsMixedILP() const {return true;};

    virtual void    DeleteYourself() throw() = 0;
...
public:
    ...
    virtual bool    VarVisibility(TVar) const throw(ERRange) {return true;};
    virtual bool    RestrVisibility(TRestr) const throw(ERRange) {return true;};
...
public:
    ...
    TVar            PivotColumn() const throw() {return pivotColumn;};
    TRestr          PivotRow() const throw() {return pivotRow;};
    TLowerUpper     PivotDirection() const throw() {return pivotDir;};

    virtual void    ResetBasis() throw() {InitBasis();};
    ...
    goblinILPWrapper*   Clone() throw(ERRejected);
    goblinILPWrapper*   DualForm() throw(ERRejected);
    goblinILPWrapper*   StandardForm() throw(ERRejected);
    goblinILPWrapper*   CanonicalForm() throw(ERRejected);
...
/// \brief  Base class for factories of #goblinILPWrapper objects

class goblinILPModule : public virtual managedObject
{
public:

    goblinILPModule() throw() {};

    virtual ~goblinILPModule() throw() {};
    ...
    virtual goblinILPWrapper*
        Reinterprete(void*) const throw(ERRange) = 0;
