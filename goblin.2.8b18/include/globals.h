...
enum TReference {
    ...
    RefHoTa74 = 60,     RefWil84 = 61,      RefEis06 = 62,      NoReference = 63
};
...
template <typename T> inline T Undefined(TBaseType _type) throw()
{
    return *((T*)UndefinedVoidPtr(_type));
}
...
enum objectType
    {IDSparseGraph = 0,IDSparseDiGraph = 1,IDSparseBiGraph = 2,
     IDBalancedFNW = 3,IDMixedGraph = 4,IDDenseGraph = 5,IDDenseDiGraph = 6,
     IDDenseBiGraph = 7,IDHashTable = 8,IDNativeLpModule = 9,
     IDGlpkWrapperModule = 10,IDNativeLpObject = 11,IDGlpkWrapperObject = 12,
     IDUnknown = 13
    };

extern const char* listOfClasses[];


// Message Classes

enum msgType
    {ERR_CHECK=0,ERR_PARSE=1,ERR_FILE=2,ERR_RANGE=3,ERR_REJECTED=4,
     ERR_INTERNAL=5,MSG_APPEND=6,MSG_WARN=7,MSG_TRACE=8,MSG_TRACE2=9,
     MSG_TIMES=10,MSG_ECHO=11,LOG_IO=12,LOG_MAN=13,LOG_MEM=14,LOG_MEM2=15,
     LOG_RES=16,LOG_RES2=17,LOG_METH=18,LOG_METH2=19,LOG_FORMULA=20,
     LOG_TITLE=21,LOG_SHELL=22,LOG_TIMERS=23,LOG_GAPS = 24,MSG_END = 25,
     NO_MSG=26,MSG_COMPOUND=128};
...
extern long unsigned goblinHeapSize;
extern long unsigned goblinMaxSize;
extern long unsigned goblinNFragments;
extern long unsigned goblinNAllocs;
extern long unsigned goblinNObjects;
