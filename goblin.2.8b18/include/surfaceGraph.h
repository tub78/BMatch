...
public:
    ...
    void            ConfigDisplay(goblinController &CFG) const throw();
    ...
    TArc FindSupport(TFloat* dist,TNode s,TArc a,dynamicStack<TNode,TFloat> &Support) throw();
    ...
    void ExpandAndAugment(TArc aIn,TArc aOut) throw();
