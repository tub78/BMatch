...
public:
    ...
    TNode N() const throw() {return nAct;};
    TArc M() const throw() {return mAct;};
    TNode L() const throw() {return lAct;};
    ...
    inline const attributePool& RepresentationalData() const throw() {return representation;};
    inline const attributePool& Geometry() const throw() {return geometry;};
    inline const attributePool& LayoutData() const throw() {return layoutData;};
